...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	// 시간 포맷(%H)
	public static final String DB_CURR_TIME_FORMAT_HOUR_ONLY = "H";
	...
	/**
	 * 현재 시각으로부터 x시간 이전의 시간 계산
	 */
	public static String getMinusHour(Integer minusHour) {
		Date today = Calendar.getInstance().getTime();
		Date subTodayHour = addHours(today , -minusHour);
		SimpleDateFormat sdfCurrent = new SimpleDateFormat(DB_CURR_TIME_FORMAT_HOUR_ONLY);

		return sdfCurrent.format(subTodayHour);
	}
